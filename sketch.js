...
class Spejder {
    ...
    async loadAnimationFrames() {
        const framePromises = [];
        // Load frames for moving left (p4spejderL)
        for (let i = 1; i <= 24; i++) {
            const frameName = `p4spejderL${i}`;
            framePromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p4spejder/${frameName}.png`));
        }
        this.framesLeft = await Promise.all(framePromises);

        const framePromisesRight = [];
        // Load frames for moving right (p4spejderR)
        for (let i = 1; i <= 24; i++) {
            const frameName = `p4spejderR${i}`;
            framePromisesRight.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p4spejder/${frameName}.png`));
        }
        this.framesRight = await Promise.all(framePromisesRight);
    }
...
class ImageIndex8Manager {
    ...
    async loadImages() {
        const warpgateAPromises = [];
        // Load warpgate A images
        for (let i = 1; i <= 6; i++) {
            const frameName = `p3warpgateA${i}`;
            warpgateAPromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p3warpgateA/${frameName}.png`));
        }
        this.warpgateAImages = await Promise.all(warpgateAPromises);

        const warpgateBPromises = [];
        // Load warpgate B images
        for (let i = 1; i <= 13; i++) {
            const frameName = `p3warpgateB${i}`;
            warpgateBPromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p3warpgateB/${frameName}.png`));
        }
        this.warpgateBImages = await Promise.all(warpgateBPromises);
    }
...
class ImageIndex11Manager {
    ...
    async loadImages() {
        ...
        await this.spejder.loadAnimationFrames();

        const warpgatePromises = [];
        // Load warpgate images
        for (let i = 1; i <= 13; i++) {
            const frameName = `p4warpgateA${i}`;
            warpgatePromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p4warpgateA/${frameName}.png`));
        }
        this.warpgateImages = await Promise.all(warpgatePromises);

        const lightTowerPromises = [];
        // Load lightTower images
        for (let i = 1; i <= 11; i++) {
            const frameName = `p4lightTower${i}`;
            lightTowerPromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p4lightTower/${frameName}.png`));
        }
        this.lightTowerImages = await Promise.all(lightTowerPromises);
    }
...
class ImageIndex13Manager {
    ...
    async loadImages() {
        const imagePaths = [
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishLeft.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishLowerLeft.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishLowerMiddle.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishLowerRight.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishUpperLeft.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/p4p3jellyfish/p4p3jellyfishUpperRight.png"
        ];
        const imagePromises = imagePaths.map(path => loadImage(path));
        this.jellyfishImages = await Promise.all(imagePromises);
...
class ImageIndex16Manager {
    ...
    async loadImages() {
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            warpgatePromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p0warpgateA/${frameName}.png`));
        }
        this.warpgateImages = await Promise.all(warpgatePromises);

        const waterPromises = [];
        // Load water animation images
        for (let i = 1; i <= 6; i++) {
            const frameName = `p0water${i}`;
            waterPromises.push(loadImage(`https://friday-fun.github.io/SpaceStrategoV1/images/p0water/${frameName}.png`));
        }
        this.waterImages = await Promise.all(waterPromises);
    }
...
class ImageIndex10Manager {
    ...
    // Load all animation assets
    async loadImagesAndAddSpacecrafts() {
        // Load all images concurrently with Promise.all
        const [
            backgroundImage, 
            blackCircleImg, 
            upperLeftImg, 
            ...
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/hangerTeamBlueEmpty1.png"),
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/blackCircleDownLeft1.png"),
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/spaceCraftUpperLeft.png"),
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/spaceCraftUpperRight.png"),
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/spaceCraftLowerLeft.png"),
            loadImage("https://friday-fun.github.io/SpaceStrategoV1/images/hangerTeamBlueEffect/spaceCraftLowerRight.png")
        ]);
...
class SpacecraftManager {
    ...
    async loadImages() {
        ...
        const imagePromises = [];
        for (let i = 1; i <= 20; i++) {
            imagePromises.push(loadImage(`https://friday-fun.github.io/images/spaceCraft/spaceCraft${i}.png`));
        }
...
class UIManager {
    ...
    checkButtonClick() {
        ...
        if (!isFlying &&
            ...
            this.roomLink = `https://friday-fun.github.io/SpaceStrategoV10/?room=${randomNumber}`;
...
class GameImageManager {
    ...
    async loadImages() {
        const imagePaths = [
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/hangerTeamGreen.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet1p1.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet1p2.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet1p3.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet2p1.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet2p2.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet3p1.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet3p2.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet3p3.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet3p4.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/hangerTeamBlue.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet4p1.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet4p2.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet4p3cleaned.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet4p4.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/logo.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet0p1.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet0p2.png",
            "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet0p3.png", "https://friday-fun.github.io/SpaceStrategoV1/images/background/planet0p4.png"
        ];

        // Clear previous images if any
        this.gameImages = [];

        // Load images using Promise.all to load them concurrently
        const imagePromises = imagePaths.map(path => loadImage(path));
        this.gameImages = await Promise.all(imagePromises);
    }
...
async function setup() {
  ...
  // Now load images for all managers - await each async operation
  await gameImageManager.loadImages();
  
  await imageIndex8Manager.loadImages();
  await imageIndex10Manager.loadImagesAndAddSpacecrafts();
  await imageIndex11Manager.loadImages();
  await imageIndex13Manager.loadImages();
  await imageIndex16Manager.loadImages();
  
  await spacecraftManager.loadImages();
